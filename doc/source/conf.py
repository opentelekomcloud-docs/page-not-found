...
otcdocs_repo_name = 'opentelekomcloud-docs/page-not-found'
...
otcdocs_service_title = 'Page Not Found'
otcdocs_service_type = 'pagenotfound'
...
html_title = "Page Not Found - Service Based View"
